...
// Adapted for J2ME/CLDC 1.1 (it5260 build): java.util.Locale isn't in CLDC,
// and the one place it was used was just to compute the platform newline
// via String.format(Locale.US, "%n") for an ASCII board printout - way more
