...
// Adapted for J2ME/CLDC 1.1 (it5260 build): java.util.List -> Vector,
// same reason as everywhere else - CLDC has no Collections framework.
package chess;
...
public interface Player {
     ...
     * @param history Vector of earlier Position objects (not including the current
     *                position). This makes it possible for the player to correctly
     *                handle the draw by repetition rule.
     */
    String getCommand(Position pos, boolean drawOffer, Vector history);
